...
if not mobs.custom_spawn_people then
	mobs:spawn({
		...
		nodes = { "mcl_wool:white_carpet","mcl_wool:brown_carpet", "mcl_wool:silver_carpet", "mcl_wool:silver_carpet", "mcl_trees:tree_birch", "mcl_trees:tree_dark_oak", "mcl_trees:tree_acacia", "mcl_trees:tree_jungle",

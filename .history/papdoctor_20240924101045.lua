...
mobs.papdoctor_drops = {"mcl_torches:torch", "mcl_armor:helmet_chain", "mcl_farming:carrot_item_gold",
...
-- if not mobs.custom_spawn_people then
    mobs:spawn({
        ...
        nodes = {"mcl_trees:tree_birch", "mcl_trees:tree_dark_oak", "mcl_trees:tree_acacia", "mcl_trees:tree_jungle",

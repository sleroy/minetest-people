local S = minetest.get_translator("people")
	...
	mobs:register_mob("people:goat", {
		stay_near = {"mcl_farming:straw", 10, "people:feeder", 10},
		stepheight = 1,
		type = "animal",
		passive = true,
	        damage = 4,

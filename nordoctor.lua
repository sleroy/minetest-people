...
mobs.nordoctor_drops = {"mcl_torches:torch", "mcl_armor:helmet_chain", "mcl_farming:carrot_item_gold",
...
mobs:spawn({
    ...
    nodes = {"mcl_trees:tree_birch", "mcl_wool:white_carpet", "mcl_wool:brown_carpet", "mcl_wool:silver_carpet",
             "mcl_wool:silver_carpet", "mcl_wool:grey_carpet", "mcl_wool:blue_carpet", "mcl_wool:green_carpet",

...
mobs:register_mob("people:rideelephant", {
	...
	follow = {
		"mcl_farming:wheat", "mcl_core:apple", "mcl_farming:oat",
		"mcl_farming:barley", "mcl_farming:corn", "mcl_core:dry_grass_1", "mcl_core:dry_grass_2", "mcl_core:dry_grass_3", "mcl_core:grass_1", "mcl_core:grass_2", "mcl_core:grass_3", "mcl_core:grass_4", "mcl_core:grass_5", "mcl_core:marram_grass_1", "mcl_core:marram_grass_2", "mcl_core:marram_grass_3", "mcl_core:coldsteppe_grass_1", "mcl_core:coldsteppe_grass_2", "mcl_core:coldsteppe_grass_3", "mcl_core:coldsteppe_grass_4", "mcl_core:coldsteppe_grass_5", "mcl_core:coldsteppe_grass_6", "naturalbiomes:savanna_grass1", "naturalbiomes:savanna_grass2", "naturalbiomes:savanna_grass3", "naturalbiomes:outback_grass1", "naturalbiomes:outback_grass2", "naturalbiomes:outback_grass3", "naturalbiomes:outback_grass4", "naturalbiomes:outback_grass5", "naturalbiomes:outback_grass6", "naturalbiomes:med_grass1", "naturalbiomes:med_grass2", "naturalbiomes:heath_grass1", "naturalbiomes:heath_grass2", "naturalbiomes:heath_grass3", "naturalbiomes:alpine_grass1", "naturalbiomes:alpine_grass2", "naturalbiomes:heath_grass2", "naturalbiomes:heath_grass3", "naturalbiomes:", "naturalbiomes:", "naturalbiomes:bushland_grass", "naturalbiomes:bushland_grass2", "naturalbiomes:bushland_grass3", "naturalbiomes:bushland_grass4", "naturalbiomes:bushland_grass5", "naturalbiomes:bushland_grass6", "naturalbiomes:bushland_grass7", "mcl_farming:melon_8", "mcl_farming:pumpkin_8", "ethereal:strawberry", "mcl_farming:blackberry", "naturalbiomes:blackberry", "naturalbiomes:cowberry", "naturalbiomes:banana", "naturalbiomes:banana_bunch", "mcl_farming:blueberries", "ethereal:orange", "livingdesert:figcactus_fruit", "livingfloatlands:paleojungle_clubmoss_fruit", "ethereal:banana", "livingdesert:date_palm_fruits", "mcl_farming:melon_slice", "naturalbiomes:wildrose", "naturalbiomes:banana", "group:grass", "group:normal_grass"},
	passive = true,
	hp_min = 100,
	hp_max = 400,
	armor = 100,
